...
public class myCircle extends myOval{
    ...
    public void draw(GraphicsContext gc,double width, double height) {
        ...
        // Draw circle
        gc.strokeOval(super.getX() - width/2,super.getY()- height/2,2*getRadius(),2*getRadius());
        gc.fillOval(super.getX()- width/2,super.getY()- height/2,2*getRadius(),2*getRadius());
    }
