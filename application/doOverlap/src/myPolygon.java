...
public class myPolygon extends myShape {
    ...
    public myRectangle getBoundingBox(double canvasWidth, double canvasHeight,Color color1){
        ...
        double halfHeight = Math.sqrt(Math.pow(super.getX() - xPoints[0],2) + Math.pow(super.getY()-yPoints[0],2));

        myRectangle rectangle1 = new myRectangle(super.getX(),super.getY(),color1,2*halfHeight,2*halfHeight);
