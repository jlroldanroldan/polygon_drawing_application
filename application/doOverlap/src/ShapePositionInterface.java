...
public interface ShapePositionInterface
    ...
    myRectangle getBoundingBox(double canvasWidth, double canvasHeight,Color color1);      // FIX RETURN TYPE
    ...
    private Shape determineSubclass(myShape myShape1){
        ...
        if( myShape1 instanceof myCircle){
            ...
            shapeTest1 = new Ellipse(myOval1.getX(),myOval1.getY(),myOval1.getAxisA(),myOval1.getAxisB());
        }
